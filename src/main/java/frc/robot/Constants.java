...
public final class Constants {
	...
	public static final double kvVoltSecondsPerMeter = 0.0279;
    public static final double kaVoltSecondsSquaredPerMeter = 0.00357;

	public static final double kPDriveVel = 0.386;
